...
{
    public class EmailSender(IConfiguration _configuration) : IEmailSender//_configuration injectuje appsetings.json fajl
    {
        //implementacija mail servisa za konfirmaciju mejla 
